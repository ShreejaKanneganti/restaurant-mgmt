var cart = {
  ...
  nuke : () => { if (confirm("Empty cart?")) {
    ...
    cart.list();
    swal("Sucess!", "Cart is Empty Successfully", "success");
  ...
  add : (id) => {
    ...
    cart.save(); cart.list();
    swal("Sucess!", "Item Add to Cart Successfully", "success");
  },
  ...
  remove : (id) => {
    ...
    cart.save();
    cart.list();
    swal("Sucess!", "Item Removed from Cart Successfully", "success");
  },
